...
const SectionSix = () => {
  return (
    <div className="section-six relative flex flex-col md:flex-row  font-medium lg:items-center lg:justify-between xl:justify-self-center  bg-black md:mx-[5%] xl:mx-[15%] p-4 md:p-0 xl:w-[65%] lg:my-15">
      ...
      <div className="bg-yellow-300 rounded-l-[50%]  md:w-[70%] xl:w-[65%]  my-[0%]  -mr-[5%] md:-mr-[0%] xl:-mr-[0%]  p-0  overflow-hidden  my-4">
        <img src={sectionFive} className="w-full " alt="hero-img" />
      </div>
    </div>
  );
};
